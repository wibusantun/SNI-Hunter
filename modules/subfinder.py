...
# Banner: 4th box design with different colors for each line
def print_banner():
    print(f"{BOLD}{CYAN}╔═══════════════════════════════╗{RESET}")
    print(f"{BOLD}{LIGHT_GREEN}║ System Resources Detected:    ║{RESET}")
    print(f"{BOLD}{YELLOW}║   - CPU Cores: {os.cpu_count()}              ║{RESET}")
...
# Main Async Function
async def main():
    print_banner()  # Print the 4th banner with random colors for each line
